...
//	    str = replaceStr(str, "    ","\t" );
    ...
    */
    ...
    public static boolean isChineseMobile(String mobiles){
    	...
    	String regex1 = "^(\\+86)?((176)|(177)|(178)|(170)|(13[0-9])|(14[0-9])|(15[^4,\\D])|(18[0-9]))\\d{8}$";
		Pattern p1 = Pattern.compile(regex1);
		Matcher m1 = p1.matcher(mobiles);
		return m1.matches();
	}
    ...
    * @throws
     ...
     *  第十七位 同意期货委托协议  第 18位 提现操作冻结,  第19位交易单位：0：币 1：张, 第20位计价货币：0：USD 1：CNY 第21位同意期货跟踪委托协议
     *  第22位同意期货冰山委托协议，	第24位同意期货时间加权委托协议
	 *  
...
//        }
    ...
    public static void main(String[] args) throws Exception {
    	System.out.println(isChineseMobile("+8615508405909"));
//    	System.out.println(randomStrAndNumber(8));
//    	System.out.println(ipToLong("192.168.0.76"));
