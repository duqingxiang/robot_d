					...
					<div class="row">
						...
						<div class="col-md-8">
							<table>
								<tr>
									<td colspan="4">
										<span class="good_title"><%=good.getGoodName() %></span>
									</td>
								</tr>
								<tr class="good_tr">
									<td colspan="4">
								...
								<tr class="good_tr">
									...
									<td class="good_td_tag"><span class="good_td_price_out">运费:</span></td>
									<td class="good_td"><span class="good_td_price_out">顺丰快递，货到付款</span></td>
								</tr>
								<tr class="good_tr">
									<td class="good_td_tag" colspan="4"><span>浏览次数：<%=good.getCountView() %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;购买次数：<%=good.getCountBuy() %></span></td>
								</tr>
								<tr class="good_tr">
									<td colspan="4"><button type="button" onclick="inCart(<%=good.getId() %>)" class="btn btn-success">加入购物车</button></td>
								</tr>
							</table>
						</div>
					</div>
